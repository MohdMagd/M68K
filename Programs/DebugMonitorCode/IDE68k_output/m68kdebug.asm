; C:\CYGWIN64\HOME\SABAS\M68K\PROGRAMS\DEBUGMONITORCODE\DEBUG MONITOR FILES\M68KDEBUG.C - Compiled by CC68K  Version 5.00 (c) 1991-2005  Peter J. Fondse
...
ProgramFlashChip_1:
       cmp.l     #134479872,D3
       bhi       ProgramFlashChip_3
; if(count == 0){
       tst.l     D4
       bne       ProgramFlashChip_4
...
; x = SPI_Data;
       move.b    4227108,D2
       bra.s     ProgramFlashChip_6
ProgramFlashChip_4:
; } else if(count == 255){
       cmp.l     #255,D4
       bne.s     ProgramFlashChip_6
; SPI_Data = *RamPtr;
       move.l    D3,A0
       move.b    (A0),4227108
; WaitForSPITransmitComplete();
...
; printf("\r\nProgramFlashChip() Completed!");
       ...
       addq.w    #4,A7
; FlashChipMemoryTest();
       jsr       _FlashChipMemoryTest
       movem.l   (A7)+,D2/D3/D4/D5/A2
       unlk      A6
       rts
; }
; void FlashChipMemoryTest(void){
       xdef      _FlashChipMemoryTest
_FlashChipMemoryTest:
       link      A6,#-4
...
; for(RamPtr=0x08000000;RamPtr<=0x08040000;RamPtr++){
       move.l    #134217728,D2
FlashChipMemoryTest_1:
       cmp.l     #134479872,D2
       bhi       FlashChipMemoryTest_3
...
; Disable_SPI_CS();
       move.b    #255,4227112
; return;
       bra.s     FlashChipMemoryTest_6
FlashChipMemoryTest_4:
       addq.l    #1,D2
       bra       FlashChipMemoryTest_1
FlashChipMemoryTest_3:
; }
; }
...
; char *CopyrightMessage = "Copyright (C) PJ Davies 2016";
       ...
       move.l    A0,-12(A6)
; char *StudentName = "Mohamed Abouelmagd";
       lea       @m68kde~1_166.L,A0
       move.l    A0,-8(A6)
; char *StudentNumber = "Std #: 38585148";
       lea       @m68kde~1_167.L,A0
       move.l    A0,-4(A6)
; KillAllBreakPoints() ;
       jsr       _KillAllBreakPoints
...
@m68kde~1_28:
       dc.b      13,10,82,117,110,110,105,110,103,32,80,114,111
       dc.b      103,114,97,109,70,108,97,115,104,67,104,105
       dc.b      112,46,46,46,46,0
@m68kde~1_29:
       dc.b      13,10,80,114,111,103,114,97,109,70,108,97,115
       dc.b      104,67,104,105,112,40,41,32,67,111,109,112,108
       dc.b      101,116,101,100,33,0
@m68kde~1_30:
       dc.b      13,10,82,117,110,110,105,110,103,32,70,108,97
       dc.b      115,104,67,104,105,112,77,101,109,111,114,121
       dc.b      84,101,115,116,46,46,46,46,0
@m68kde~1_31:
       dc.b      13,10,32,70,108,97,115,104,32,67,104,105,112
       dc.b      32,77,101,109,111,114,121,32,84,101,115,116
       dc.b      32,70,97,105,108,101,100,33,0
@m68kde~1_32:
       dc.b      13,10,32,70,97,105,108,101,100,32,97,116,32
       dc.b      37,100,116,104,32,66,121,116,101,33,0
@m68kde~1_33:
       dc.b      13,10,70,108,97,115,104,32,67,104,105,112,32
       dc.b      77,101,109,111,114,121,32,84,101,115,116,32
       dc.b      83,117,99,99,101,115,115,102,117,108,33,0
@m68kde~1_34:
...
@m68kde~1_35:
       dc.b      13,10,76,111,97,100,105,110,103,32,80,114,111
       dc.b      103,114,97,109,32,70,114,111,109,32,83,80,73
       dc.b      32,70,108,97,115,104,32,83,117,99,99,101,115
       dc.b      115,102,117,108,33,0
@m68kde~1_36:
...
@m68kde~1_150:
       ...
       dc.b      41,32,58,0
@m68kde~1_151:
       dc.b      80,101,114,102,111,114,109,105,110,103,32,77
       dc.b      101,109,111,114,121,32,84,101,115,116,33,0
@m68kde~1_152:
       dc.b      13,10,83,116,97,114,116,32,65,100,100,114,101
       dc.b      115,115,58,32,0
@m68kde~1_153:
...
@m68kde~1_154:
       ...
       dc.b      32,70,97,105,108,101,100,33,0
@m68kde~1_155:
       dc.b      13,10,65,100,100,114,101,115,115,32,61,32,37
       dc.b      117,0
@m68kde~1_156:
       dc.b      13,10,68,97,116,97,32,87,114,105,116,116,101
       dc.b      110,32,116,111,32,97,100,100,114,101,115,115
       dc.b      32,61,32,37,117,0
@m68kde~1_157:
       dc.b      13,10,68,97,116,97,32,102,111,117,110,100,32
       dc.b      105,110,32,97,100,100,114,101,115,115,32,61
       dc.b      32,37,117,0
@m68kde~1_158:
       dc.b      77,101,109,111,114,121,32,84,101,115,116,32
       dc.b      70,97,105,108,101,100,33,0
@m68kde~1_159:
       dc.b      13,10,77,101,109,111,114,121,32,84,101,115,116
       dc.b      32,83,117,99,99,101,115,115,102,117,108,0
@m68kde~1_160:
       dc.b      77,101,109,111,114,121,32,84,101,115,116,32
       dc.b      83,117,99,99,101,115,115,102,117,108,33,0
@m68kde~1_161:
...
@m68kde~1_163:
       dc.b      13,10,67,104,105,112,32,69,114,97,115,101,100
       dc.b      33,0
@m68kde~1_164:
...
@m68kde~1_165:
       ...
       dc.b      49,54,0
@m68kde~1_166:
       dc.b      77,111,104,97,109,101,100,32,65,98,111,117,101
       dc.b      108,109,97,103,100,0
@m68kde~1_167:
       dc.b      83,116,100,32,35,58,32,51,56,53,56,53,49,52
       dc.b      56,0
@m68kde~1_168:
