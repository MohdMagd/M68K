...
int main(int argc, char *argv[])
{
  ...
  if((SourceFilePtr =  fopen("C:\\M68K\\Programs\\DebugMonitorCode\\IDE68k_output\\debugmonitorproject.hex", "r")) == NULL)	{
	...
	if((DestFilePtr = fopen("C:\\M68K\\Programs\\debugmonitorproject.mif","w")) == NULL)	{
